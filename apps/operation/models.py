...
class  UserAsk(models.Model):
    name = models.CharField(max_length=20,verbose_name=u'用户名字')
    moble = models.CharField(max_length=11,verbose_name=u'手机')
...
class UserFavorite(models.Model):
    ...
    fav_type = models.IntegerField(choices=(('1','课程机构'),('2','课程'),('3','讲师')),verbose_name=u'收藏类型')
