...
class CityDict(models.Model):
    name = models.CharField(max_length=250,verbose_name=u'城市名')
    desc = models.CharField(max_length=50,verbose_name=u'城市描述')
...
class Teacher(models.Model):
    ...
    work_position = models.CharField(max_length=20,verbose_name=u'公司职位')
