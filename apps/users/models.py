...
class EmailVerifyRecord(models.Model):
    ...
    send_type = models.CharField(choices=(('register','注册'),('forget',u'找回密码')),max_length=10,verbose_name=u'注册OR找回')
    send_time = models.TimeField(default=datetime.now,verbose_name=u'时间')
    #实例化的时间
    class Meta:
